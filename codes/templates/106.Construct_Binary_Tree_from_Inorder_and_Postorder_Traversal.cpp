...
void Test1()
{
    ...
    std::vector<int> postorder = {1,2,3,0,5,6};
    ...
    std::cout << "        1       " << std::endl;
    ////////////////////////////////////
    Test("Test1", inorder, postorder, p_node6);
    std::cout << "----------------" << std::endl;
}
void Test2()
{
    std::vector<int> inorder   = {3,9,20,7,15} ;
    std::vector<int> postorder = {3,9,7,15,20} ;
    ...
    Test("Test2", inorder, postorder, p_node20);
    std::cout << "----------------" << std::endl;
}
...
void Test3()
{
    ...
    Test("Test2", inorder, postorder, p_node5);
    std::cout << "----------------" << std::endl;
}
...
void Test4()
{
    ...
    Test("Test4", inorder, postorder, p_node3);
    std::cout << "----------------" << std::endl;
}

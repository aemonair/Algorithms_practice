...
以1为根节点,找到位于1左边的数字能组成的树集合func(start, 0)(nullptr) 找到位于1右边数字能组成的树的集合 func(2,end);
     1                                                                           1       1
       \                                                                           \      \
         [2,3]         而func(2, end)即func(2,3)可以寻找 2～3节点生成的子树;        2       3
                        找到{以2为根的3为子树的树+以3为根的2为子树的树};             \    /
                                                                                      3  2
以2为根节点,找到位于2左边的数字能组成的树集合func(start, 1) 找到位于2右边数字能组成的树的集合 func(3,end);
         2
       /  \
     [1]   [3]
以3为根节点,找到位于3左边的数字能组成的树集合func(start, 2) 找到位于3右边数字能组成的树的集合 func(4,end)(nullptr);
         3
       /
     [1,2]
